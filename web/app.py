#!/usr/bin/env python3
"""
Solana Wallet Dashboard - Flask Web App
"""
...
@app.route('/')
def dashboard():
    return render_template('dashboard.html', wallet=WALLET_ADDRESS)
...
def api_volume():
    ...
    # Calculate USD values and format response
    tokens_volume = []
    ...
    return jsonify({
        "wallet": WALLET_ADDRESS,
        "tokens": tokens_volume[:20],  # Top 20
        "totals": totals,
